...
const submissions = [
  {
    tag: 'editorial',
    slug: 'submission-test1-e8t1',
    title: 'Submission Test 1',
    subtitle: 'Submission test 1',
    id: 'e8t1',
    stats: {
      images: '1',
      words: '119'
    ...
    status: 'scheduled',
    summary: 'This is officially test 1',
    content: {
      raw: {
        document: {
          data: {},
  ...
  {
    slug: 'submission-test2-e8t2',
    title: 'Submission Test 2',
    subtitle: 'Submission test 2',
    id: 'e8t2',
    stats: {
      images: '1',
      words: '119'
    ...
    status: 'pending',
    summary: 'This is officially test 2',
    content: {
      raw: {
        document: {
          data: {},
